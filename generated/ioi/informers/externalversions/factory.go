...
import (
	...
	ioi "sigs.k8s.io/IOIsolation/generated/ioi/informers/externalversions/ioi"
)
...
func (f *sharedInformerFactory) Ioi() ioi.Interface {
	return ioi.New(f, f.namespace, f.tweakListOptions)
}
